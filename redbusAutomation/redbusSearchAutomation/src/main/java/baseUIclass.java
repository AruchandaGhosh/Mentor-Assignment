...
public class baseUIclass {
    ...
    public String selectDateIncalendar(String date) {
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("DD Mon YYY");
        Date expectedDate =null;
        try {
            expectedDate = dateFormat.parse(date);

            String day = new SimpleDateFormat("DD").format(expectedDate);
            String month = new SimpleDateFormat("Mon").format(expectedDate);
            String year = new SimpleDateFormat("YYYY").format(expectedDate);

            String expectedMonthYear = month + "" + year;

            while (true) {
                String displayDate =driver.findElement(By.xpath("//*[@id='onward_cal']/span/div/div/div[1]/div")).getText();
                ...
                if (expectedMonthYear.equalsIgnoreCase(displayDate)) {
                    ...
                    {
                        day1.deleteCharAt(0);
                        driver.findElement(By.xpath("//*[@id='onward_cal']//a[text()= '" + day1 + "']")).click();
                    }
                    else
                    {
                        driver.findElement(By.xpath("//*[@id='onward_cal']//a[text()= '" + day + "']")).click();
                    }
                    break;
                } else if (expectedDate.compareTo(currentDate) > 0) {
                    driver.findElement(By.xpath("//*[@id='onward_cal']/span/div/div/div[1]/a[2]/span")).click();
                } else {
                    driver.findElement(By.xpath("//*[@id='onward_cal']/span/div/div/div[1]/a[1]/span")).click();
                }
        ...
        dateFormat = new SimpleDateFormat("E, DD Mon YYYY");
    ...
    public String selectDate()
    {
        ...
        String result=null;
        Date date = new Date();
        SimpleDateFormat DateFor = new SimpleDateFormat("DD Mon YYYY");
